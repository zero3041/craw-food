    ...
    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="backdrop-blur-sm bg-gradient-to-r from-slate-500/10 to-gray-500/10 px-8 py-6 border-b border-white/10">
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="flex items-center justify-end space-x-3">
            <span className="text-xl font-black text_white">Price</span>
            <div className="w-10 h-10 bg-gradient-to-r from_green-400 to-emerald-400 rounded-2xl flex items-center justify-center shadow-lg">
              <svg className="w-5 h-5 text_white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="max-h-96 overflow-y-auto">
        {filteredMenuItems.map((product, index) => (
          <div key={product.id} onClick={() => copyProductInfo(product)} className={`group relative grid grid_cols-3 gap-8 px-8 py-6 border-b border-white/5 hover:bg-white/5 cursor-pointer transition-all duration-300 ${index % 2 === 0 ? 'bg-white/[0.02]' : 'bg-white/[0.05]'} hover:shadow-xl`}>
            <div className="absolute inset-0 bg-gradient-to-r from-green-400/0 via-emerald-400/0 to-cyan-400/0 group-hover:from_green-400/5 group-hover:via-emerald-400/5 group-hover:to-cyan-400/5 transition-all duration-500 rounded-2xl"></div>
            <div className="relative flex items-center space-x-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-gradient-to-r from-green-400 via-emerald-400 to-cyan-400 rounded-2xl flex items-center justify_center text-white font-black text-sm shadow-lg">{index + 1}</div>
              </div>
            ...
            <div className="relative flex items_center">
            ...
            <div className="relative flex flex-col items-end justify-center space-y-2">
              ...
              {copiedId === product.id && (
                <div className="flex items-center space-x-2 text-green-400 text-sm font-bold animate-pulse">
                  <div className="w-5 h-5 bg-green-400 rounded-full flex items-center justify_center">
      ...
      <div className="backdrop-blur-sm bg-gradient-to-r from_green-500/10 via-emerald-500/10 to-cyan-500/10 p-8 border-t border-white/10">
        <div className="flex items-start space-x-6">
          <div className="w-16 h-16 bg-gradient_to-r from-green-400 via-emerald-400 to-cyan-400 rounded-3xl flex items-center justify-center shadow-2xl flex-shrink-0">
